		...
		<div class="swiper-container main-slider" data-effect="fade" data-autoplay="4000">
						...
						<div class="row table-cell">
							...
							<div class="col-lg-12">
								...
								<div class="slider-content align-center">
									...
									<h1 class="slider-content-title" data-swiper-parallax="-100">Optimización de motores de búsqueda</h1>
									<h5 class="slider-content-text c-gray" data-swiper-parallax="-200">¡Descubra más sobre nuestra experiencia SEO!</h5>

									<div class="main-slider-btn-wrap" data-swiper-parallax="-300">

										<a href="04_service_detail_seo.php"
										   class="btn btn-medium btn--dark btn-hover-shadow">
											<span class="text">Aprende más</span>
							...
							<div class="col-lg-5 table-cell">
								<div class="slider-content">
									<h3 class="slider-content-title" data-swiper-parallax="-100">
										<span class="c-dark">REDES SOCIALES</span>
										se trata de atraer clientes a sus puertas.</h3>

									<div class="main-slider-btn-wrap" data-swiper-parallax="-300">

										<a href="05_service_details_localseo.php"
										   class="btn btn-medium btn--dark btn-hover-shadow">
											<span class="text">Aprende más</span>
											<span class="semicircle"></span>
										</a>

										<a href="05_service_details_localseo.php" class="btn btn-small btn--primary"
							...
							<div class="col-lg-6 table-cell">
								...
								<div class="slider-content">
									...
									<h3 class="h1 slider-content-title c-dark" data-swiper-parallax="-100">
										Desarrollo de Sistemas Webs
									</h3>

									<h5 class="slider-content-text" data-swiper-parallax="-200">
										No esperes mas para tener tu pagina web, Nosotros lo hacemos posible...
									</h5>

									<div class="main-slider-btn-wrap" data-swiper-parallax="-300">

										<a href="06_service_detail.php" class="btn btn-medium btn--dark btn-hover-shadow">
											<span class="text">Aprende más</span>
											<span class="semicircle"></span>
										</a>

										<a href="06_service_detail.php" class="btn btn-medium btn-border">
					...
					<div class="container table">
						<div class="row table-cell">
							...
							<div class="col-lg-12">
								...
								<div class="slider-content align-center">
									<h3 class="h1 slider-content-title c-dark" data-swiper-parallax="-100">Facturación Electronica</h3>
									<h5 class="slider-content-text" data-swiper-parallax="-200">Tu sistema de facturación 
										hara que tu empresa sea innovadora 
										y hara crecer tu ventas,
										ya que emplearas ventas de forma 
										legal y sin infringir la ley...									</h5>

									<div class="main-slider-btn-wrap" data-swiper-parallax="-300">

										<a href="07_service_email_marketing.php"
										   class="btn btn-medium btn--dark btn-hover-shadow">
											<span class="text">Aprende más</span>
											<span class="semicircle"></span>
										</a>
						...
						<div class="row table-cell">
							...
							<div class="col-lg-6 table-cell">
								<div class="slider-content">
									...
									<h5 class="slider-content-text" data-swiper-parallax="-200">Diseño y Desarrollo
										 de aplicaciones, creamos soluciones...
									</h5>

									<div class="main-slider-btn-wrap" data-swiper-parallax="-300">

										<a href="08_service_ppc_management.php"
										   class="btn btn-medium btn--dark btn-hover-shadow">
											<span class="text">APREnde más</span>
											<span class="semicircle"></span>
										</a>
			...
			<div class="slider-slides">
				...
				<a href="#" class="slides-item bg-primary-color">
					<div class="content">
						<div class="text-wrap">
							<h4 class="slides-title">Redes Sociales</h4>
				...
				<a href="#" class="slides-item bg-secondary-color">
					<div class="content">
						<div class="text-wrap">
							<h4 class="slides-title">Desarrollo de Sistemas Webs</h4>
						</div>
				...
				<a href="#" class="slides-item bg-green-color">
					<div class="content">
						<div class="text-wrap">
							<h4 class="slides-title">Desarrollo de APPS	</h4>
						</div>
		...
		<div class="row">
			<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
				<div class="info-box--standard" data-mh="info-boxes">
					...
					<div class="info-box-content">
						<h5 class="info-box-title">Estrategia De Búsqueda Local</h5>
			...
			<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
				<div class="info-box--standard" data-mh="info-boxes">
					...
					<div class="info-box-content">
						<h5 class="info-box-title">Optimización De Búsqueda De Maps</h5>
					</div>
				</div>
			</div>
			...
			<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
				<div class="info-box--standard" data-mh="info-boxes">
					...
					<div class="info-box-content">
						<h5 class="info-box-title">Construcción De Enlaces Y Contenido</h5>
					</div>
				</div>
			</div>
			...
			<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
				<div class="info-box--standard" data-mh="info-boxes">
					...
					<div class="info-box-content">
						<h5 class="info-box-title">Publicidad De Búsqueda Pagada</h5>
					</div>
				</div>
			</div>
			...
			<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
				<div class="info-box--standard" data-mh="info-boxes">
					...
					<div class="info-box-content">
						<h5 class="info-box-title">Diseño De Sitios Web Personalizados</h5>
					</div>
				</div>
			</div>
			...
			<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
				<div class="info-box--standard" data-mh="info-boxes">
					...
					<div class="info-box-content">
						<h5 class="info-box-title">Diseño De Correo Electrónico Personalizado</h5>
					</div>
				</div>
			</div>
		</div>
						...
						<div class="col-lg-8 col-lg-offset-2 col-md-8 col-md-offset-2 col-xs-12 col-sm-12">
							<div class="seo-score-content align-center">
								...
								<div class="heading align-center">
									<h4 class="h1 heading-title">¿Su puntuación SEO?</h4>
									<p class="heading-text">¡Consulta los problemas de SEO de tu sitio web gratis!</p>
								</div>

								<div class="seo-score-form">

									<form class="seo-score-form input-inline crumina-submit" data-nonce="crumina-submit-form-nonce" data-type="standard" action="phpfiles/submit.php">

										<div class="row">

											<div class="col-lg-8 no-padding col-md-12 col-xs-12 col-sm-12">
												<input name="site" class="input-dark site" placeholder="Escriba la URL de su sitio web" required>
											</div>
											<div class="col-lg-4 no-padding col-md-12 col-xs-12 col-sm-12">
												<input name="email" class="input-dark e-mail" placeholder="Tu correo electrónico" type="email" required>
											</div>

										</div>

										<button class="btn btn-medium btn--green btn-hover-shadow" name="send">
											<span class="text">Chequeo!</span>
											<span class="semicircle"></span>
										</button>
				...
				<div class="offers">
					<div class="row">
						<div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
							<div class="heading">
								<h4 class="h1 heading-title">Ofrecemos una gama completa de servicios de marketing digital.</h4>
					...
					<div class="row">
						<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
							<div class="heading">
								<p class="heading-text">Somos los expertos en todas las dimensiones del marketing digital, utilizando estrategias de
									 neuromarketing para conocer los gustos y preferencias de tu target.
								</p>
							</div>
							...
							<ul class="list list--secondary">
								...
								<li>
									<i class="seoicon-check"></i>
									<a href="#">CONTENIDO - ARQUITECTURA</a>
								</li>
							</ul>

							<a href="03_services.php" class="btn btn-medium btn-border c-primary">
								<span class="text">Aprende más</span>
								<span class="semicircle"></span>
							</a>

							<a href="10_testimonials.php" class="btn btn-medium btn--primary btn-hover-shadow">
								<span class="text">Consigue una cotización</span>
								<span class="semicircle"></span>
							</a>
			...
			<div class="our-video js-equal-child">
				<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 no-padding">
					<div class="video theme-module">
						<div class="video-thumb">
							...
							<a href="https://www.youtube.com/watch?v=-ADgtz9o2Bo" class="video-control js-popup-iframe">
				...
				<div class="col-lg-4 col-lg-offset-1 col-md-4 col-md-offset-1 col-sm-12 col-xs-12 no-padding">
					<div class="content theme-module centered-on-mobile medium-padding100">
						<div class="heading">
							<h4 class="h1 heading-title">Mira nuestro video</h4>
							<div class="heading-line">
								<span class="short-line"></span>
								<span class="long-line"></span>
							</div>
							<p class="heading-text">Somos una empresa que 
								brinda servicios informáticos de forma integral en la asesoría y consultoría en hardware y 
								software, tanto para usuarios domésticos, negocios y empresas corporativas. Prestamos 
								nuestros servicios en forma altamente personalizada, 
								comprendiendo que cada empresa es única, creando una solución a la medida de 
								tus necesidades. Logrando identificar y entender 
								las necesidades de nuestros clientes para ofrecerle la mejor solución.
							</p>
						</div>
						<a href="02_abouts.php" class="btn btn-medium btn--secondary">
				...
				<div class="container">
					<div class="row">
						<div class="col-lg-8 col-lg-offset-2 col-md-8 col-md-offset-2 col-sm-12 col-xs-12">
							<div class="heading align-center">
								<h4 class="h1 heading-title">Paquetes de servicios de SEO asequibles</h4>
								<div class="heading-line">
									<span class="short-line"></span>
									<span class="long-line"></span>
								</div>
					...
					<div class="row">
						<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
							<div class="info-box--standard-centered">
								...
								<div class="info-box-content">
									<h4 class="info-box-title">Objetivo</h4>
						...
						<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
							<div class="info-box--standard-centered">
								...
								<div class="info-box-content">
									<h4 class="info-box-title">ESTRATEGIA</h4>
						...
						<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
							<div class="info-box--standard-centered">
								...
								<div class="info-box-content">
									<h4 class="info-box-title">TECNOLOGÍA</h4>
						...
						<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
							<div class="info-box--standard-centered">
								...
								<div class="info-box-content">
									<h4 class="info-box-title">ANALÍTICA</h4>
					...
					<div class="row align-center">
						<div class="btn-block">
							<a href="03_services.php" class="btn btn-medium btn--dark">
								<span class="text">Más Información</span>
								<span class="semicircle"></span>
							</a>
							<a href="03_services.php" class="btn btn-medium btn--breez">
								<span class="text">!EMPEZAR!</span>
								<span class="semicircle"></span>
							</a>
						</div>
				...
				<div class="container">
					<div class="row">
						<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
							<div class="heading">
								<h4 class="h1 heading-title">Clientes felices sobre nosotros</h4>
								<div class="heading-line">
									<span class="short-line bg-yellow-color"></span>
									<span class="long-line bg-yellow-color"></span>
								</div>
								<p class="heading-text c-white">Nuestros clientes nos respaldan.
								</p>
							</div>
